...
export default function Login() {
    ...
    return (
        <div>
            {/* --- Sign In Form (formsign === 'signin') --- */}
            {
                formsign === 'signin' ? (
                    <div>
                        <h1 className="text-3xl font-bold text-blue-600 text-center mt-6">Feedback Form</h1>
                                ...
                                <div className="md:max-w-md w-full px-4 py-4">
                                    <form onSubmit={handleLogin}> {/* Added onSubmit handler */}
                                        <div className="mb-12">
                                            ...
                                            <p className="text-[15px] mt-6 text-slate-600">Don't have an account <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap" onClick={() => handleFormSwitch('signup')}>Register here</a></p>
                                        </div>
                                        ...
                                        <div className="mt-8">
                                            ...
                                            <div className="relative flex items-center">
                                                <input name="password" type="password" required className="w-full text-slate-900 text-sm border-b border-slate-300 focus:border-blue-600 pl-2 pr-8 py-3 outline-none" placeholder="Enter password" value={password} onChange={(e) => setPassword(e.target.value)} />
                                                {/* Eye SVG here */}
                                        ...
                                        <div className="flex flex-wrap items-center justify-between gap-4 mt-8">
                                            ...
                                            <div>
                                                <Link to="/forgot-password" className="text-blue-600 font-medium text-sm hover:underline">
                                                    Forgot Password?
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                <div className="md:max-w-md w-full px-4 py-4">
                                    <form onSubmit={handleRegister}> {/* Added onSubmit handler */}
                                        <div className="mb-12">
                                            ...
                                            <p className="text-[15px] mt-6 text-slate-600">Already have an account? <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap" onClick={() => handleFormSwitch('signin')}>Sign in here</a></p>
                                        </div>

                                        <div>
                                            <label className="text-slate-900 text-[13px] font-medium block mb-2">Name</label>
                                            <div className="relative flex items-center mb-6">
                                                <input name="name" type="text" required className="w-full text-slate-900 text-sm border-b border-slate-300 focus:border-blue-600 pl-2 pr-8 py-3 outline-none" placeholder="Enter name" value={name} onChange={(e) => setName(e.target.value)} />
                                                <FaRegUser className='w-[18px] h-[18px] absolute right-2 text-slate-400' />
                                                {/* --- REMOVED THE COMPLEX/BROKEN SVG HERE, REPLACED BY FaRegUser --- */}
                                            </div>

                                            <label className="text-slate-900 text-[13px] font-medium block mb-2">Email</label>
                                            <div className="relative flex items-center">
                                                <input name="email" type="email" required className="w-full text-slate-900 text-sm border-b border-slate-300 focus:border-blue-600 pl-2 pr-8 py-3 outline-none" placeholder="Enter email" value={email} onChange={(e) => setEmail(e.target.value)} />
                                                {/* Email SVG here */}
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
                                                    <defs>
                                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                                        ...
                                        <div className="flex flex-wrap items-center justify-between gap-4 mt-8">
                                            <div className="flex items-center">
                                                <input id="remember-me-register" name="remember-me" type="checkbox" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-slate-300 rounded-sm" />
                                                <label htmlFor="remember-me-register" className="ml-3 block text-sm text-slate-900">
                                                    Remember me
                                                </label>
                                            </div>
                                            <div>
